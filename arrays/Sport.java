...
//10 Datatypes VariablName[] ={value1,value2,...};
   static String sportMaterial[] = {"Cricet Bat","football","Hockey","Badmitan","Medals","carrom board","Jerssy","leather board","Trophies","vollyball","ball","net","wicket","bat","chess board"};
   
   static int price[] = {1000, 3000, 1200, 5000, 250, 500, 5000, 2000, 500, 2000,500,2000,3000,1200,2000};
   ...
   //looping statement
   System.out.println("The Length of sportMaterials is"+ sportMaterials.length );
   for(int devsIndex=0 ; devsIndex < sportMaterials.length; devsIndex++ ){
   System.out.println(sportMaterials[devsIndex]);
   }
